...
RUN echo "Installing DESC requested packages" && \
    ...
    /bin/bash -c 'source $LSST_STACK_DIR/loadLSST.bash; \
                  ...
                  pip install -c $LSST_STACK_DIR/require.txt https://github.com/LSSTDESC/desc-dc2-dm-data/archive/v0.9.0.tar.gz; \
                  ...
                  setup fftw; \
                  setup gsl; \
                  pip install -c $LSST_STACK_DIR/require.txt pyccl==2.2.0;'
...
RUN echo "Installing additional python packages" && \
    /bin/bash -c 'source $LSST_STACK_DIR/loadLSST.bash; \
                  ...
                  pip install -c $LSST_STACK_DIR/require.txt dask-mpi; \
...
RUN echo "Installing GCR packages" && \
    /bin/bash -c 'source $LSST_STACK_DIR/loadLSST.bash; \
                  ...
                  pip install https://github.com/LSSTDESC/gcr-catalogs/archive/v1.2.2.tar.gz' 
